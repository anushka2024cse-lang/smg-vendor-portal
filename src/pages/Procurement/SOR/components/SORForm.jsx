                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        {isEditMode ? (
                            ...
                            <div className="px-3 py-2 text-sm text-slate-900 font-medium">{formData.sorNumber}</div>
                        )}
                    </div>
                    <div>
                        ...
                        {isEditMode ? (
                            ...
                            <div className="px-3 py-2 text-sm text-slate-900">{formData.vendor || '-'}</div>
                        )}
                    </div>
                    <div>
                        ...
                        {isEditMode ? (
                            ...
                            <div className="px-3 py-2 text-sm text-slate-900">{formData.documentNumber}</div>
                        )}
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        {isEditMode ? (
                            ...
                            <div className="px-3 py-2 text-sm text-slate-900 font-medium">{formData.companyName || '-'}</div>
                        )}
                    </div>
                    <div>
                        ...
                        {isEditMode ? (
                            ...
                            <div className="px-3 py-2 text-sm text-slate-900">{formData.enquirerName || '-'}</div>
                        )}
                    </div>
                    <div>
                        ...
                        {isEditMode ? (
                            ...
                            <div className="px-3 py-2 text-sm text-slate-900">{formData.contactInfo || '-'}</div>
                        )}
                    </div>
                    <div>
                        ...
                        {isEditMode ? (
                            ...
                            <div className="px-3 py-2 text-sm text-slate-900">{formData.natureOfCompany || '-'}</div>
                        )}
                    </div>
                    <div>
                        ...
                        {isEditMode ? (
                            ...
                            <div className="px-3 py-2 text-sm text-slate-900">{formData.keyAccountManager || '-'}</div>
                        )}
                    </div>
                    <div>
                        ...
                        {isEditMode ? (
                            ...
                            <div className="px-3 py-2 text-sm text-slate-900">{formData.technicalEngineer || '-'}</div>
                        )}
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        {isEditMode ? (
                            ...
                            <div className="px-3 py-2 text-sm text-slate-900">{formData.vehicleType}</div>
                        )}
                    </div>
                    <div>
                        ...
                        {isEditMode ? (
                            ...
                            <div className="px-3 py-2 text-sm text-slate-900">{formData.chargerRatingV}</div>
                        )}
                    </div>
                    <div>
                        ...
                        {isEditMode ? (
                            ...
                            <div className="px-3 py-2 text-sm text-slate-900">{formData.chargerRatingW}</div>
                        )}
                    </div>
                </div>
            </div>
                    ...
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="bg-slate-100 text-slate-600 text-xs font-semibold uppercase">
                                ...
                                {isEditMode && <th className="px-4 py-3 text-center border border-slate-200 w-20">Actions</th>}
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr key={spec.id} className="hover:bg-slate-50">
                                    <td className="px-4 py-3 border border-slate-200">
                                        {isEditMode ? (
                                            ...
                                            <div className="text-sm text-slate-900">{spec.specification || '-'}</div>
                                        )}
                                    </td>
                                    <td className="px-4 py-3 border border-slate-200">
                                        {isEditMode ? (
                                    ...
                                    <td className="px-4 py-3 border border-slate-200">
                                        {isEditMode ? (
                                            ...
                                            <div className="text-sm text-slate-900">
                                                <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${spec.compliance === 'Yes' ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' :
                                                        spec.compliance === 'No' ? 'bg-red-50 text-red-700 border border-red-200' :
                                    ...
                                    <td className="px-4 py-3 border border-slate-200">
                                        {isEditMode ? (
                                            ...
                                            <div className="text-sm text-slate-600">{spec.remarks || '-'}</div>
                                        )}
                                    </td>
                                    {isEditMode && (
