        ...
        <div className="p-8 max-w-7xl mx-auto text-slate-500 w-full">
            <div className="flex items-center gap-4 mb-6">
                <div>
                    ...
                    <h1 className="text-2xl font-bold text-slate-900">Material Dispatch</h1>
                </div>
            </div>

            {/* Add New Material Dispatch Form */}
            <div className="bg-white p-6 rounded-xl border border-slate-200 mb-8 shadow-sm">
                <h2 className="text-lg font-semibold text-slate-900 mb-2">Add New Material Dispatch</h2>
                <p className="text-sm text-slate-500 mb-6">Log a new outgoing material dispatch. This will automatically update inventory levels.</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                        <label className="block text-sm font-medium mb-1 text-slate-700">Date of Dispatching</label>
                    ...
                    <div>
                        <label className="block text-sm font-medium mb-1 text-slate-700">No. of Units Dispatched</label>
                    ...
                    <div>
                        <label className="block text-sm font-medium mb-1 text-slate-700">Dispatched To</label>
                        <input type="text" placeholder="e.g. Assembly Line 1" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600 text-sm" />
                    </div>
                    <div>
                        <label className="block text-sm font-medium mb-1 text-slate-700">Dispatched At (Location)</label>
                        <input type="text" placeholder="e.g. Factory Floor" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600 text-sm" />
                    </div>

                    <div>
                        <label className="block text-sm font-medium mb-1 text-slate-700">HOD Name</label>
                        <input type="text" placeholder="e.g. Mike Ross" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600 text-sm" />
                    </div>
                    <div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-slate-200 flex justify-between items-center">
                    <div>
                        <h2 className="text-lg font-semibold text-slate-900 mb-1">Dispatch History</h2>
                        <p className="text-sm text-slate-500">A log of all past material dispatches.</p>
                    </div>
                    ...
                    <table className="w-full text-sm text-left whitespace-nowrap">
                        <thead className="text-xs text-slate-500 uppercase bg-slate-50 border-b border-slate-200">
                            <tr>
                                ...
                                <th className="px-4 py-3 font-semibold text-slate-600">Date Disp.</th>
                                ...
                                <th className="px-4 py-3 font-semibold text-slate-600">Disp. To</th>
                                <th className="px-4 py-3 font-semibold text-slate-600">Disp. At</th>
                                <th className="px-4 py-3 font-semibold text-slate-600">HOD Name</th>
                                ...
                                <th className="px-4 py-3 font-semibold text-slate-600">Disp. By</th>
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {history.length > 0 ? history.map((item, index) => (
                                <tr key={item.id} className="hover:bg-slate-50 transition-colors group">
                                    ...
                                    <td className="px-4 py-3 text-slate-600">{item.dateDisp}</td>
                                    ...
                                    <td className="px-4 py-3 text-slate-600">{item.dispTo}</td>
                                    <td className="px-4 py-3 text-slate-600">{item.dispAt}</td>
                                    <td className="px-4 py-3 text-slate-600">{item.hodName}</td>
                                    ...
                                    <td className="px-4 py-3 text-slate-600">{item.dispBy}</td>
